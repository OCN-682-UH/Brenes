...
of a **HOT plot** (good plot) and a **not so HOT plot** (bad plot). Both plots are using 20
years worth of low level nitrogen concentration data and picoeukayrote
FCM data collected by the Hawaii Ocean Time-series (HOT) from Station
ALOHA.
